...
export class Checkout extends PureComponent {
  ...
  renderProgressBar() {
    ...
    const stepIndex = stepMapKeys.indexOf(checkoutStep);

    // console.log(checkoutStep,stepMap,stepMapKeys,stepIndex);
    return (
      <ProgressBar list={["Shipping", "Review & Payments"]} index={stepIndex} />
    );
  }
